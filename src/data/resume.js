...
export const experience = [
  {
    ...
    period: '2026–Present',
    description: "Full-stack development fundamentals through Cognizant's intensive bootcamp program. Developed responsive UIs, built and optimized front-end components, and implemented interactive features using React, JavaScript, and Node.js.",
    highlights: ['HTML / CSS / Bootstrap', 'JavaScript / React', 'Node.js / Express', 'Git workflow'],
  },
  {
    role: 'Frontend Developer (Client: CliftonLarsonAllen)',
    company: 'Cognizant',
    period: 'Apr 2026 – Jul 2026',
    description: 'Developed and maintained enterprise web applications for form management solutions. Implemented features, debugged defects, and collaborated with QA and business stakeholders on a React + TypeScript stack.',
    highlights: ['React / TypeScript / JavaScript', 'REST APIs / SQL Server', 'Azure DevOps / Git', 'Agile Scrum', 'Code reviews & PRs'],
  },
  {
    role: 'Hardware & Technical Support Intern',
    company: 'Twireless Inc.',
    period: 'Mar 2025 – Jun 2025',
    description: 'Diagnosed and resolved hardware/software issues, performed system maintenance, and provided technical support across departments. Managed inventory and quality checks.',
    highlights: ['Troubleshooting', 'System maintenance', 'Network concepts', 'Inventory management'],
  },
];

export const projects = [
  {
    title: 'Web-based Monitoring Application for Adaptive Fish Silage Fermentation',
    year: 2025,
    description: 'Real-time data-driven monitoring dashboard for fermentation control. Collected pH, ammonia, and temperature sensor data from ESP32, processed through Firebase, and visualized with actionable indicators.',
    tech: ['React.js', 'Firebase', 'Koa', 'ESP32', 'ETL Pipeline'],
  },
  {
    title: 'Adaptive Fish Silage Fermentation Control System',
    year: 2025,
    description: 'React Native mobile app for real-time monitoring and control. Calibrated and integrated IoT sensors (load-cell, pH, temperature, ammonia) with a reliable data pipeline.',
    tech: ['React Native', 'Firebase', 'Koa', 'IoT / Arduino', 'Real-time sync'],
  },
  {
    title: 'Portable Solar-Powered Desalination System',
    year: 2024,
    description: 'Designed and built a modular, portable desalination unit with integrated ultra-filtration for safe drinking water. Led core design, integrated PPM sensors with real-time validation.',
...
export const curatedCertifications = [
  ...
  { name: 'The Complete Microservices & Event-Driven Architecture', date: 'Mar 2026' },
...
export const allCertifications = [
  ...
  { name: 'Accountability Training For Managers and Corporate Employees', date: 'Jan 2026' },
  { name: 'React 18 / 19 Course 2025 - Learn React JS the Fast Way', date: 'Mar 2026' },
  { name: 'React & TypeScript - The Practical Guide', date: 'Mar 2026' },
  { name: 'The Ultimate Redux Course 2026 - [LATEST Redux-toolkit]', date: 'Mar 2026' },
  { name: 'The Complete Microservices & Event-Driven Architecture', date: 'Mar 2026' },
  { name: 'Microservices: Designing Highly Scalable Systems', date: 'Mar 2026' },
  { name: 'Microservices Architecture - The Complete Guide', date: 'Mar 2026' },
  { name: 'Prompt Engineering Foundation', date: 'Apr 2026' },
  { name: 'Intro to AI Agents: Build an Army of Digital Workers with AI', date: 'Apr 2026' },
  { name: 'AI Agents: Building Teams of LLM Agents that Work For You', date: 'Apr 2026' },
  { name: 'AI Agents - 101 Basics', date: 'Apr 2026' },
  { name: "Claude AI: The AI Assistant You'll Actually Use", date: 'Apr 2026' },
  { name: 'Claude, Claude Code, Claude Cowork, and Claude in MS Office', date: 'May 2026' },
  { name: 'Claude Awareness Program', date: 'May 2026' },
  { name: 'Machine Learning for Absolute Beginners - Level 1', date: 'May 2026' },
  { name: 'Executive Briefing: Deep Learning (DL)', date: 'May 2026' },
  { name: 'Executive Briefing: Natural Language Processing (NLP)', date: 'May 2026' },
  { name: 'Azure OpenAI Services - The Complete Guide', date: 'May 2026' },
